...
import './navbar.css'
import { navbarText } from "../../helper/data";

const Navbar = () => {
  return (
    <div className="navbar">
      <div className="jotformLogo">
        <div className="jotformLogoIcon" style={{ width: "150px", height: "150px" }}>
          <svg
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 367 66"
            class="jl-main jfLogo-white"
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              ...
              class="jl-main-color jl-main-text jl-main-text-all"
              fill="#0A1551"
            ></path>
            <path
      ...
      <div className="navbarText">
        {navbarText.map((item, i) => (
          <h5 className="textItem" key={i}>{item}</h5>
        ))}
      </div>
    </div>
  );
